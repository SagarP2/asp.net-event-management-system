<%@ Page Title="" Language="C#" MasterPageFile="~/AdminM/admin.Master" AutoEventWireup="true" CodeBehind="AddDecorator.aspx.cs" Inherits="Event_Managament_Sysyem.AdminM.AddDecorator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="style1" style="height: 256px; width: 50%; border: 2px solid; margin-left: 500px; margin-top: 50px">
        <tr>
            <td colspan="2" class="tblhead">Add Decorator</td>
        </tr>
        <tr>
            <td class="style12">&nbsp;</td>
            <td class="style14">&nbsp;</td>
        ...
        <tr>
            <td class="lbl">Decorator Name : </td>
            <td style="text-align: left">
                <asp:TextBox ID="txtname" runat="server" placeholder="Enter Decortor Name" CssClass="txt" Width="200px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                    ControlToValidate="txtname" ErrorMessage="Enter Decoator"
        ...
        <tr>
            ...
            <td style="text-align: left" class="style17">
                <asp:Button ID="btnadd" runat="server" CssClass="btn"
                    Style="margin-top: 14px" Text="Add Decorator" Width="200px"
    ...
    <div class="A">
    <asp:GridView runat="server" ID="GridViewD" CssClass="gridview" AutoGenerateColumns="true"></asp:GridView>
</div>
