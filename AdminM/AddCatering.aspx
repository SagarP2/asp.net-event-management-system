<%@ Page Title="" Language="C#" MasterPageFile="~/AdminM/admin.Master" AutoEventWireup="true" CodeBehind="AddCatering.aspx.cs" Inherits="Event_Managament_Sysyem.AdminM.AddCatering" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="style1" style="height: 256px; width: 50%; border: 2px solid; margin-left: 500px; margin-top: 50px">
        <tr>
            <td colspan="2" class="tblhead">Add Catering</td>
        </tr>
        <tr>
            <td class="style12">&nbsp;</td>
            <td class="style14">&nbsp;</td>
        ...
        <tr>
            <td class="lbl">Catering Name : </td>
            <td style="text-align: left">
                <asp:TextBox ID="txtname" runat="server" placeholder="Enter catering Name" CssClass="txt" Width="200px"></asp:TextBox>
        ...
        <tr>
            <td class="lbl">Price Per Plate : </td>
            <td style="text-align: left">
        ...
        <tr>
            ...
            <td style="text-align: left" class="style17">
                <asp:Button ID="btnadd" runat="server" CssClass="btn"
                    Style="margin-top: 14px" Text="Add Cater" Width="200px"
    ...
    <div class="A">
        <asp:GridView runat="server" ID="GridViewcatering" CssClass="gridview" AutoGenerateColumns="true"></asp:GridView>
    </div>
